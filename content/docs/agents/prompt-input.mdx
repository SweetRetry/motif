...
```bash
npx shadcn@latest add https://startercn.vercel.app/r/prompt-input.json
```

Pulls in [attachment](https://startercn.vercel.app/docs/components/attachment) for the chips
...
[attachment](https://startercn.vercel.app/docs/components/attachment), and the round controls
