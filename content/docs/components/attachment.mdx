...
| Status      | Renders                                                                               |
| ----------- | ------------------------------------------------------------------------------------- |
| `uploading` | Progress arc around the card plus the percentage; a preview darkens under a scrim     |
...
clockwise in the theme's `primary` — or `white` over a preview, where `primary` would
disappear. The reference mock used a blue accent; swap the token for a literal blue if you
want that hue.
