...
} from "@/examples/generation-overlay";

<ComponentPreview
  name="generation-overlay"
  src="registry/new-york/generation-overlay.tsx"
>
  <GenerationOverlayDemo />
</ComponentPreview>
...
```bash
npx shadcn@latest add https://motif-sweetretrys-projects.vercel.app/r/generation-overlay.json
```
