...
import {
  SettingsModalDemo,
  SettingsPanelsDemo,
} from "@/examples/settings-modal";

<ComponentPreview name="settings-modal">
  <SettingsModalDemo />
</ComponentPreview>
...
```bash
npx shadcn@latest add https://startercn.vercel.app/r/settings-modal.json
```
...
export function Preferences() {
  return (
    <SettingsModal nav={NAV} title="Settings">
      {(id) =>
        id === "workspace" ? (
...
`active` and `onActiveChange` make the selection controlled when something outside the
...
<ComponentPreview name="settings-modal" align="start">
  <SettingsPanelsDemo />
</ComponentPreview>
...
| `active`         | —            | Controlled active destination                                                      |
| `defaultActive`  | first item   | Where an uncontrolled modal opens                                                  |
...
<ComponentSource
  name="settings-modal"
  src="registry/new-york/settings-modal/index.tsx"
  title="settings-modal.tsx"
/>

<ComponentSource
  name="settings-modal"
  src="registry/new-york/settings-modal/types.ts"
  title="types.ts"
/>
