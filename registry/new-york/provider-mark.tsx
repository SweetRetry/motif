...
const MARKS: Record<ProviderId, ReactElement<SVGProps<SVGSVGElement>>> = {
  ...
  anthropic: (
    <svg fill="currentColor" fillRule="evenodd" viewBox="0 0 24 24">
  ...
  kling: (
    <svg viewBox="0 0 24 24">
      <path
        ...
        fill="url(#lobe-icons-kling-0-_R_0_)"
      />
      <path
        ...
        fill="url(#lobe-icons-kling-1-_R_0_)"
      />
      <path
        ...
        fill="url(#lobe-icons-kling-2-_R_0_)"
      />
      <path
        ...
        fill="url(#lobe-icons-kling-3-_R_0_)"
      />
      <defs>
        <radialGradient
          cx="0"
  ...
  luma: (
    <svg viewBox="0 0 24 24">
      ...
      <path
        ...
        fill="url(#lobe-icons-luma-0-_R_0_)"
      />
      <path
        d="M12.392 24L2 18l10.392-6 10.393 6-10.393 6z"
        fill="url(#lobe-icons-luma-1-_R_0_)"
      />
      <path
        d="M2 5.999L12.392 0v24L2 18V5.999z"
        fill="url(#lobe-icons-luma-2-_R_0_)"
        style={{ mixBlendMode: "screen" }}
      />
      <path
        d="M12.392 24L2 18l10.392-6 10.393 6-10.393 6z"
        fill="url(#lobe-icons-luma-3-_R_0_)"
        style={{ mixBlendMode: "overlay" }}
      />
      <path
        d="M2 5.999L12.392 0v24L2 18V5.999z"
        fill="url(#lobe-icons-luma-4-_R_0_)"
        style={{ mixBlendMode: "overlay" }}
      />
      <defs>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id="lobe-icons-luma-0-_R_0_"
          x1="2"
          x2="22.785"
          y1="18"
          y2="18"
  ...
  meta: (
    <svg viewBox="0 0 24 24">
      <path
        ...
        fill="url(#lobe-icons-meta-0-_R_0_)"
      />
      <path
        ...
        fill="url(#lobe-icons-meta-1-_R_0_)"
      />
      <path
      ...
      <path
        ...
        fill="url(#lobe-icons-meta-5-_R_0_)"
      />
      <path
      ...
      <path
        ...
        fill="url(#lobe-icons-meta-6-_R_0_)"
      />
      <path
      ...
      <path
        ...
        fill="url(#lobe-icons-meta-7-_R_0_)"
      />
      <path
        ...
        fill="url(#lobe-icons-meta-8-_R_0_)"
      />
      <path
        ...
        fill="url(#lobe-icons-meta-9-_R_0_)"
      />
      <path
      ...
      <path
        ...
        fill="url(#lobe-icons-meta-12-_R_0_)"
      />
      <defs>
        <linearGradient
          id="lobe-icons-meta-0-_R_0_"
          x1="75.897%"
          x2="26.312%"
          y1="89.199%"
          y2="12.194%"
  ...
  qwen: (
    <svg viewBox="0 0 24 24">
      <path
        ...
        fill="url(#lobe-icons-qwen-_R_0_)"
        fillRule="nonzero"
      />
      <defs>
        <linearGradient
          id="lobe-icons-qwen-_R_0_"
          x1="0%"
          x2="100%"
          y1="0%"
          y2="0%"
